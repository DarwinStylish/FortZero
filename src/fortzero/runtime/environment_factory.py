            ...
            return RuntimeState(
                ...
                nodes=[
                    NodeState(
                        ...
                        discovered=True,
                        services=[
                            ServiceState(name="ssh", port=22, state="filtered", note="high friction"),
                            ServiceState(name="https", port=443, state="open", note="login surface"),
                        ],
                    ),
                    NodeState(
                        id="wkst-01",
                        ...
                        discovered=False,
                        services=[
                            ServiceState(name="rdp", port=3389, state="closed", note="not externally reachable"),
                            ServiceState(name="agent-beacon", port=8443, state="hidden", note="not yet visible"),
                        ],
                    ),
                ],
